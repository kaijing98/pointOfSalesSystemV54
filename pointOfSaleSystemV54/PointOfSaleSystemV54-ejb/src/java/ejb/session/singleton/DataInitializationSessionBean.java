...
public class DataInitializationSessionBean
{
    ...
    private void initializeData()
    {
        try
        {
            ...
            customerEntitySessionBeanLocal.createNewCustomer(new CustomerEntity("Kaijing", "Xu", "kaijing", "kaijing98@gmail.com", "password"));
        ...
        catch(CustomerUsernameExistException | StaffUsernameExistException | ProductSkuCodeExistException | UnknownPersistenceException | InputDataValidationException | CreateNewCategoryException | CreateNewTagException | CreateNewProductException ex)
        {
            ex.printStackTrace();
        }
    }
